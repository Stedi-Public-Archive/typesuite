...
export class TypeSuiteClient implements NetSuiteClient {
  ...
  asyncAddList(request: AsyncAddListRequest): Promise<AsyncStatusResponse | InsufficientPermissionFault | InvalidSessionFault | InvalidCredentialsFault | ExceededConcurrentRequestLimitFault | ExceededRecordCountFault | ExceededRequestSizeFault | ExceededRequestLimitFault | UnexpectedErrorFault> {
    return this.executePort(request, "asyncAddList");
  }

  asyncDeleteList(request: AsyncDeleteListRequest): Promise<AsyncStatusResponse | InsufficientPermissionFault | InvalidSessionFault | InvalidCredentialsFault | ExceededConcurrentRequestLimitFault | ExceededRecordCountFault | ExceededRequestSizeFault | ExceededRequestLimitFault | UnexpectedErrorFault> {
    return this.executePort(request, "asyncDeleteList");
  }

  asyncGetList(request: AsyncGetListRequest): Promise<AsyncStatusResponse | InsufficientPermissionFault | InvalidSessionFault | InvalidCredentialsFault | ExceededConcurrentRequestLimitFault | ExceededRecordCountFault | ExceededRequestSizeFault | ExceededRequestLimitFault | UnexpectedErrorFault> {
    return this.executePort(request, "asyncGetList");
  }

  asyncInitializeList(request: AsyncInitializeListRequest): Promise<AsyncStatusResponse | InsufficientPermissionFault | InvalidSessionFault | InvalidCredentialsFault | ExceededConcurrentRequestLimitFault | ExceededRecordCountFault | ExceededRequestLimitFault | ExceededUsageLimitFault | ExceededRequestSizeFault | UnexpectedErrorFault> {
    return this.executePort(request, "asyncInitializeList");
  }

  asyncSearch(request: AsyncSearchRequest): Promise<AsyncStatusResponse | InsufficientPermissionFault | InvalidSessionFault | InvalidCredentialsFault | ExceededConcurrentRequestLimitFault | ExceededRecordCountFault | ExceededRequestSizeFault | ExceededRequestLimitFault | UnexpectedErrorFault> {
    return this.executePort(request, "asyncSearch");
  }

  asyncUpdateList(request: AsyncUpdateListRequest): Promise<AsyncStatusResponse | InsufficientPermissionFault | InvalidSessionFault | InvalidCredentialsFault | ExceededConcurrentRequestLimitFault | ExceededRecordCountFault | ExceededRequestSizeFault | ExceededRequestLimitFault | UnexpectedErrorFault> {
    return this.executePort(request, "asyncUpdateList");
  }

  asyncUpsertList(request: AsyncUpsertListRequest): Promise<AsyncStatusResponse | InsufficientPermissionFault | InvalidSessionFault | InvalidCredentialsFault | ExceededConcurrentRequestLimitFault | ExceededRecordCountFault | ExceededRequestSizeFault | ExceededRequestLimitFault | UnexpectedErrorFault> {
  ...
  checkAsyncStatus(request: CheckAsyncStatusRequest): Promise<AsyncStatusResponse | InsufficientPermissionFault | InvalidSessionFault | InvalidCredentialsFault | ExceededConcurrentRequestLimitFault | ExceededRequestLimitFault | UnexpectedErrorFault | AsyncFault> {
