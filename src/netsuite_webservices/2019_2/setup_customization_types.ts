...
export type CustomizationSearchLevel = "_none" | "_edit" | "_run";

export type CustomizationAccessLevel = "_none" | "_edit" | "_view";
...
export type ItemCustomFieldItemSubType = "_both" | "_purchase" | "_sale";
