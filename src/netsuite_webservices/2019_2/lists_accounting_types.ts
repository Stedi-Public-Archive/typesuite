...
export type ItemPreferenceCriterion =
  "_A" |
  "_B" |
  "_C" |
  "_D" |
...
export type CurrencyCurrencyPrecision =
  "_two" |
  "_zero";

export type ItemAtpMethod =
  "_cumulativeAtpWithLookAhead" |
  "_discreteAtp";
...
export type PeriodicLotSizeType =
  "_interval" |
  "_monthly" |
  "_weekly";

export type HazmatPackingGroup =
  "_i" |
  "_ii" |
  "_iii";
...
export type ItemSupplyReplenishmentMethod =
  "_reorderPoint" |
  "_timePhased";
...
export type SalesTaxItemAvailable =
  "_both" |
  "_purchase" |
  "_sale";

export type ItemInvtClassification =
  "_a" |
  "_b" |
  "_c";

export type BillingScheduleRecurrenceMode =
  "_dom" |
  "_dowim";

export type AccountingBookStatus =
  "_active" |
  "_inactive" |
  "_pending";
...
export type ItemWeightUnit =
  "_g" |
  "_kg" |
  "_lb" |
  "_oz";

export type ConsolidatedRate =
  "_average" |
  "_current" |
  "_historical";
...
export type RevRecScheduleAmortizationType =
  "_standard" |
  "_variable";
...
export type InventoryItemFraudRisk =
  "_high" |
  "_low" |
  "_medium";
