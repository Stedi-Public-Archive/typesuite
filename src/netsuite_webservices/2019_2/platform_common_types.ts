...
export type VsoePermitDiscount =
  "_asAllowed" |
  "_never";
...
export type CurrencySymbolPlacement =
  "_afterNumber" |
  "_beforeNumber";
...
export type CscMatchCode =
  "_n" |
  "_x" |
  "_y";

export type AvsMatchCode =
  "_n" |
  "_x" |
  "_y";
...
export type AlcoholRecipientType =
  "_consumer" |
  "_licensee";
